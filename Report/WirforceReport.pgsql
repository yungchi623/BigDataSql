...
--select * from ana.get_report(timestamp '2019-11-21',NOW()::timestamp); --產生至今的報告
--select * from ana.get_report(timestamp 'yesterday',NOW()::timestamp); --產生昨天到今天的報告
select * from ana.get_report(timestamp '2019-11-18 00:00:00', timestamp '2019-11-24 23:59:59'); --產生至今的報告(假日)
--select * from ana.get_report(timestamp '2019-11-22 12:00:00', timestamp '2019-11-23 12:00:00');
--select * from ana.get_report(timestamp '2019-11-23 12:00:00', timestamp '2019-11-24 12:20:00');
