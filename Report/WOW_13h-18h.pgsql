DROP FUNCTION IF EXISTS ana.wow_time2(startDate TIMESTAMP, endDate TIMESTAMP , inputusername VARCHAR , inputserserialno VARCHAR );
CREATE FUNCTION ana.wow_time2(startDate TIMESTAMP, endDate TIMESTAMP ,inputusername VARCHAR='',  inputserserialno VARCHAR  ='')
RETURNS TABLE 
    (
        username VARCHAR,
        serialno VARCHAR,
...
select * from ana.wow_time2 (timestamp  '2019-11-11','2019-11-17');
